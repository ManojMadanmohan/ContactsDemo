...
public class ContactsViewAdapter extends RecyclerView.Adapter<ContactsViewAdapter.ContactsViewHolder> implements SectionIndexer{
    ...
    private void initSections() {
        ...
        _sections = arr;
        for(int i=0; i<_contactSummaries.size(); i++) {
    ...
    public int getSectionForPosition(int i) {
        ...
        if(i >= _contactSummaries.size()) {
            return getSectionForPosition(_contactSummaries.size() - 1);
        }
        CharSequence startingChar = getStartingChar(_contactSummaries.get(i));
        int secVal=0;
